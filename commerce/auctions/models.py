...
class Category(models.Model):  # listeleme kategorisini temsil eder
...
class Listing(models.Model):
    ...
    categories = models.ManyToManyField(
        Category, blank=True, related_name="select_category")  # seçim için tüm kategoriler
